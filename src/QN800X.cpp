 ...
 *   tx.setTxStereo(true);
 *   qn800x_status1 s1 = tx.getStatus1();
 ...
 *
 */
qn800x_status1 QN800X::getStatus1() {
  qn800x_status1 value;
 ...
 *   tx.setTX(1069); // Sets the transmitter to 106.9 MHz
 *   tx.setTxStereo(true);
 *   qn800x_status2 s2 = tx.getStatus2();
 ...
 * @endcode
 */
qn800x_status2 QN800X::getStatus2() {
  qn800x_status2 value;
 ...
 *   tx.setTxStereo(true);
 *   ...
 *   qn800x_status3 s3 = tx.getStatus2();
 ...
 * @endcode
 */
qn800x_status3 QN800X::getStatus3() {
  qn800x_status3 value;
 ...
 * @details The functions described in this group are used to configure the QN800X.
 */

/**
 * @ingroup group02 Init Device
 * @brief Starts the  QN800X instance.
 * @details It is a minimalist code to initiate the QN800X device. Use the function setup if you want more option during the start process.
 * @details Example
 * @code
 * #include <QN800X.h>
 * QN800X tx;
 ...
 */
inline void QN800X::setTxMode(uint8_t value) {
 ...
 */
void QN800X::startTransmitting() {
  this->setTxMode(1);
}

/**
 * @ingroup group02 Init Device
 * @brief QN800X initial configuration
 ...
 * @endcode
 */
void QN800X::setup(uint16_t xtalDiv,
                   bool mono, bool rds,
 ...
 * @brief QN800X Receiver funtions
 * @details The functions defined in this group are responsible for controlling the reception of the QN800X.
*/
 ...
 */
void QN800X::setRX(uint16_t frequency) {
  this->system1.raw = 0B11100011;
 ...
 */
void QN800X::setRxFrequency(uint16_t frequency) {
  this->rxCurrentFrequency = frequency;
  uint16_t channel = (frequency - 600)  * 2;
  qn800x_rx_ch rxch;
  qn800x_ch_step ch_step;
 ...
 * @param max
 */
void QN800X::setRxFrequencyRange(uint16_t min, uint16_t max ) {
 ...
 * @todo under construction...
 */
void QN800X::setRxFrequencyDown() {
 ...
 * @param value
 */
void QN800X::setRxFrequencyStep(uint8_t value) {
  qn800x_ch_step step;
 ...
 */
void QN800X::rdsEnableRX(bool value) {
 ...
 */
void QN800X::setAudioMuteRX(bool value) {
 ...
 */
void QN800X::scanRxStation(uint16_t startFrequency, uint16_t stopFrequyency, uint8_t frequencyStep ) {

  qn800x_ch_start start;
  qn800x_ch_stop stop;
  qn800x_ch_step step;
 ...
 * @todo under construction...
 */
void QN800X::rdsRxEnable(bool value) {
  this->system2.arg.rx_rdsen = value;
  this->setRegister(QN_SYSTEM2, this->system2.raw);
}
 ...
 * @todo under construction...
 */
char* QN800X::rdsRxGetPS(char *ps) {
 ...
 * @todo under construction...
 */
char* QN800X::rdsRxGetRT(char *rt) {
 ...
 * @todo under construction...
 */
char* QN800X::rdsRxGetTime(char *time) {
 ...
 * @details The functions defined in this group are responsible for controlling the transmitting  of the QN800X.
 */
 ...
 */
void QN800X::setTX(uint16_t frequency) {
  this->system1.raw = 0B11100011;
  this->setRegister(QN_SYSTEM1, this->system1.raw); // SYSTEM1 => 11100011  =>  swrst = 1; recal = 1; stnby = 1; ccs_ch_dis = 1; cca_ch_dis = 1
  this->setRegister(QN_SYSTEM2, this->system2.raw);
  this->system2.arg.rdsrdy = !(this->system2.arg.rdsrdy); // Toggle
...
/**
 * @ingroup group02 Init Device
 * @brief QN800X initial configuration of the of reference clock source
 ...
 * @endcode
*/
void QN800X::setXtal(uint16_t divider, uint8_t xtalInj, uint8_t imageRejection) {
 ...
 * @endcode
 */
void  QN800X::setTxStereo( bool value ) {
  qn800x_system2 system2;
 ...
 * @endcode
 */
void  QN800X::setTxMono(uint8_t value) {
  qn800x_system2 system2;
  system2.raw = this->getRegister(QN_SYSTEM2);
  system2.arg.tx_mono = value;
  this->setRegister(QN_SYSTEM2, system2.raw);
 ...
 * @endcode
 */
void QN800X::setTxPreEmphasis( uint8_t value ) {
  qn800x_system2 system2;
  system2.raw = this->getRegister(QN_SYSTEM2);
 ...
 * @endcode
 */
void QN800X::setPreEmphasis( uint8_t value ) {
  qn800x_system2 system2;
  system2.raw = this->getRegister(QN_SYSTEM2);
 ...
 * @endcode
 */
void QN800X::setTxPilotGain(uint8_t value) {
  qn800x_gplt gptl;
 ...
 * @endcode
 */
void QN800X::setTxSoftClipThreshold(uint8_t value) {
  qn800x_gplt gptl;
  gptl.raw = this->getRegister(QN_GPLT);
 ...
 * @endcode
 */
void QN800X::setTxOffAfterOneMinuteNoAudio(bool value) {
  qn800x_gplt gptl;
  gptl.raw = this->getRegister(QN_GPLT);
 ...
 * @endcode
 */
void QN800X::setTxOffAfterOneMinute(uint8_t value) {
  qn800x_gplt gptl;
  gptl.raw = this->getRegister(QN_GPLT);
 ...
 * @endcode
 */
void QN800X::setAudioAnalogGain(uint8_t value) {
  qn800x_vol_ctl vol_ctl;
 ...
 * @endcode
 */
void QN800X::setAudioDigitalGain(uint8_t value) {
  qn800x_vol_ctl vol_ctl;
 ...
 * @endcode
 */
void QN800X::setAudioDacHold(bool value) {
  qn800x_vol_ctl vol_ctl;
 ...
 * @endcode
 */
void QN800X::setAudioTxDiff(bool value) {
  qn800x_vol_ctl vol_ctl;
 ...
 *
 * @param value  (true or false)
 * @see Data Sheet - Quintic - QN800X - Digital FM Transceiver for Portable Devices, pag. 35
 * @details Example
 * @code
 * #include <QN800X.h>
 * QN800X tx;
 ...
 * @endcode
 */
void QN800X::setTxInputImpedance(uint8_t value) {
  qn800x_reg_vga reg_vga;
 ...
 * @endcode
 */
void QN800X::setTxDigitalGain(uint8_t value) {
  qn800x_reg_vga reg_vga;
 ...
 * @endcode
 */
void QN800X::setTxInputBufferGain(uint8_t value) {
  qn800x_reg_vga reg_vga;
 ...
 * @endcode
 */
void QN800X::setTxSoftClippingEnable( bool value) {
  qn800x_reg_vga reg_vga;
  reg_vga.raw = this->getRegister(QN_REG_VGA);
 ...
 * @endcode
 */
 void QN800X::setTxFrequencyDerivation(uint8_t value) {
  this->fdev.raw = value;
 ...
 * @endcode
 */
void QN800X::setPAC(uint8_t PA_TRGT) {
 ...
 * @endcode
 */
void QN800X::setToggleTxPdClear() {
  qn800x_pac pac;
 ...
 * @endcode
 */
void QN800X::rdsSetMode(uint8_t mode) {
  qn800x_int_ctrl int_ctrl;
 ...
 * @endcode
 */
void QN800X::rdsSet4KMode(uint8_t value) {
  qn800x_int_ctrl int_ctrl;
  int_ctrl.raw = this->getRegister(QN_INT_CTRL);
 ...
 * @endcode
 */
void QN800X::rdsSetInterrupt(uint8_t value) {
  qn800x_int_ctrl int_ctrl;
  int_ctrl.raw = this->getRegister(QN_INT_CTRL);
 ...
 */
void QN800X::rdsInitTx(uint8_t countryId, uint8_t programId, uint8_t reference, uint8_t pty, uint8_t rdsSyncTime, uint8_t rdsRepeatGroup) {
 ...
 */
void QN800X::rdsSetPI(uint8_t countryId, uint8_t programId, uint8_t reference) {
  RDS_BLOCK1 pi;
 ...
 * @see rdsSetPI, rdsInitTx, rdsTxEnable, rdsGetPI, rdsSetPTY, rdsGetPTY, rdsSetTP, rdsGetTP rdsSetSyncTime, rdsSetRepeatSendGroup
 */
void QN800X::rdsTxEnable(bool value) {
  qn800x_system2 system2;
  system2.raw = this->getRegister(QN_SYSTEM2);
 ...
 * @endcode
 */
void QN800X::rdsSetFrequencyDerivation(uint8_t freq) {
  qn800x_rds rds;
 ...
 * @endcode
 */
void QN800X::rdsSetTxLineIn(bool value) {
  qn800x_rds rds;
  rds.raw = this->getRegister(QN_RDS);
...
/**
 * @ingroup group05 TX RDS
 * @brief Sends a RDS group (four blocks)  to the QN800X
 ...
 */
void QN800X::rdsSendGroup(RDS_BLOCK1 block1, RDS_BLOCK2 block2, RDS_BLOCK3 block3, RDS_BLOCK4 block4) {
 ...
 * @param stationName
 */
void QN800X::rdsSetStationName(char *stationName) {
 ...
 * @endcode
 */
void QN800X::rdsSendRTMessage(char *rt) {
 ...
 */
int32_t QN800X::calculateMJD(uint16_t year, uint8_t month, uint8_t day) {
 ...
 * @todo Under construction
 */
void QN800X::rdsSendDateTime(uint16_t year, uint8_t month, uint8_t day, uint8_t hour, uint8_t min, int8_t offset) {
...
/** @defgroup group10 QN800X FSM functions **/
 ...
 * @endcode
 */
uint8_t QN800X:: getFsmStateCode() {
  qn800x_status1 s1;
  s1.raw = this->getRegister(QN_STATUS1);
  return s1.arg.FSM;
}
 ...
 */
void QN800X::resetFsm() {
  qn800x_system1 system1;
 ...
 * @param value - true or false
 */
void QN800X::setStnby(bool value) {
  qn800x_system1 system1;
  system1.raw = this->getRegister(QN_SYSTEM1);
